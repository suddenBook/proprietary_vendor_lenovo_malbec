...
if [ -d /proc/sys/walt ]; then
	...
	echo 0 > /sys/devices/system/cpu/cpu1/core_ctl/enable

	# Disable core control for titaniums
	...
	echo 0x20 > /proc/sys/walt/sched_sbt_pause_cpus
	...
	echo 16000000 16000000 16000000 16000000 16000000 16000000 5000000 > /proc/sys/walt/sched_coloc_busy_hyst_cpu_ns
	...
	echo 8500000 8500000 8500000 8500000 8500000 8500000 2000000 > /proc/sys/walt/sched_util_busy_hyst_cpu_ns
	echo 127 > /proc/sys/walt/sched_util_busy_hysteresis_enable_cpus
	echo 1 1 1 1 1 1 15 > /proc/sys/walt/sched_util_busy_hyst_cpu_util
	...
	echo "walt" > /sys/devices/system/cpu/cpufreq/policy1/scaling_governor
	...
	echo 0 > /sys/devices/system/cpu/cpufreq/policy1/walt/down_rate_limit_us
	echo 0 > /sys/devices/system/cpu/cpufreq/policy1/walt/up_rate_limit_us
	...
	echo 1 > /sys/devices/system/cpu/cpufreq/policy1/walt/pl
	...
	echo 787200 > /sys/devices/system/cpu/cpufreq/policy1/walt/rtg_boost_freq
	echo 787200 > /sys/devices/system/cpu/cpufreq/policy4/walt/rtg_boost_freq
	...
	echo 1190400 > /sys/devices/system/cpu/cpufreq/policy1/walt/hispeed_freq
	echo 1190400 > /sys/devices/system/cpu/cpufreq/policy4/walt/hispeed_freq
	echo 1478400 > /sys/devices/system/cpu/cpufreq/policy6/walt/hispeed_freq
...
echo 633600 > /sys/devices/system/cpu/cpufreq/policy1/scaling_min_freq
echo 480000 > /sys/devices/system/cpu/cpufreq/policy4/scaling_min_freq
echo 614400 > /sys/devices/system/cpu/cpufreq/policy6/scaling_min_freq
echo "0:441600 1:633600 4:480000 6:614400" > /data/vendor/perfd/default_scaling_min_freq

# Reset the RT boost, which is 1024 (max) by default.
echo 0 > /proc/sys/kernel/sched_util_clamp_min_rt_default

# cpuset parameters
echo 0-1 5 > /dev/cpuset/background/cpus
echo 0-1 5 > /dev/cpuset/system-background/cpus
