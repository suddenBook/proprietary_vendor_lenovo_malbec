...
if [ -d /proc/sys/walt ]; then
	...
	echo 0x10 > /proc/sys/walt/sched_sbt_pause_cpus
	...
	echo 60 > /proc/sys/walt/sched_coloc_busy_hysteresis_enable_cpus
	...
	echo 14 > /proc/sys/walt/sched_pipeline_cpus
	...
	echo 1075200 0 0 0 0 0 > /proc/sys/walt/input_boost/input_boost_freq
	...
	echo 1478400 > /sys/devices/system/cpu/cpufreq/policy5/walt/hispeed_freq
...
echo 614400 > /sys/devices/system/cpu/cpufreq/policy5/scaling_min_freq
echo "0:441600 1:633600 4:480000 5:614400" > /data/vendor/perfd/default_scaling_min_freq
