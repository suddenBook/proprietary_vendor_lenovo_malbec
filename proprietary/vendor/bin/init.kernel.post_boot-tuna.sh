...
case "$variant" in
	"2_3_2_1")
		/vendor/bin/sh /vendor/bin/init.kernel.post_boot-tuna_default_2_3_2_1.sh
		;;
	"1_3_2_1")
		/vendor/bin/sh /vendor/bin/init.kernel.post_boot-tuna_1_3_2_1.sh
		;;
	"2_3_2_0")
		/vendor/bin/sh /vendor/bin/init.kernel.post_boot-tuna_2_3_2_0.sh
		;;
	"2_2_2_1")
		/vendor/bin/sh /vendor/bin/init.kernel.post_boot-tuna_2_2_2_1.sh
		;;
	"2_3_1_1")
...
# set rq_affinity to 0 on ufs devices
