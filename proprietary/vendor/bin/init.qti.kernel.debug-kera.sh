...
config_dcc_gcc()
{
    ...
    echo 0x110058  > $DCC_PATH/config
    echo 0x125008  > $DCC_PATH/config
    echo 0x13C004 2 > $DCC_PATH/config
    echo 0x143004  > $DCC_PATH/config
    echo 0x14300C  > $DCC_PATH/config
    echo 0x143020  > $DCC_PATH/config
    echo 0x143044  > $DCC_PATH/config
    echo 0x143144  > $DCC_PATH/config
    echo 0x144018  > $DCC_PATH/config
    echo 0x144020  > $DCC_PATH/config
    echo 0x14415C 3 > $DCC_PATH/config
    echo 0x14417C 16 > $DCC_PATH/config
    echo 0x14428C 2 > $DCC_PATH/config
    echo 0x1442A0  > $DCC_PATH/config
    echo 0x1442A8 16 > $DCC_PATH/config
    echo 0x1443B8 2 > $DCC_PATH/config
    echo 0x144500  > $DCC_PATH/config
    echo 0x144600  > $DCC_PATH/config
    echo 0x145144  > $DCC_PATH/config
    echo 0x146038 3 > $DCC_PATH/config
    echo 0x147034 3 > $DCC_PATH/config
    echo 0x148144  > $DCC_PATH/config
    echo 0x14828C  > $DCC_PATH/config
    echo 0x14829C  > $DCC_PATH/config
    echo 0x148500  > $DCC_PATH/config
    echo 0x14B004  > $DCC_PATH/config
    echo 0x163020  > $DCC_PATH/config
    echo 0x163500  > $DCC_PATH/config
    echo 0x171018 2 > $DCC_PATH/config
    echo 0x171144  > $DCC_PATH/config
    echo 0x171500  > $DCC_PATH/config
    echo 0x174004 2 > $DCC_PATH/config
    echo 0x174034  > $DCC_PATH/config
    echo 0x174054 2 > $DCC_PATH/config
    echo 0x174060 2 > $DCC_PATH/config
    echo 0x17418C 2 > $DCC_PATH/config
    echo 0x1741A0  > $DCC_PATH/config
    echo 0x1741A8 16 > $DCC_PATH/config
    echo 0x1742B8 2 > $DCC_PATH/config
    echo 0x1742D4 16 > $DCC_PATH/config
    echo 0x1743E4 2 > $DCC_PATH/config
    echo 0x174400 16 > $DCC_PATH/config
    echo 0x174510 2 > $DCC_PATH/config
    echo 0x17452C 16 > $DCC_PATH/config
    echo 0x17463C 2 > $DCC_PATH/config
    echo 0x174658 16 > $DCC_PATH/config
    echo 0x174784 16 > $DCC_PATH/config
    echo 0x174894  > $DCC_PATH/config
    echo 0x1748A0 5 > $DCC_PATH/config
    echo 0x1748B8 5 > $DCC_PATH/config
    echo 0x1748F0  > $DCC_PATH/config
    echo 0x1748F8  > $DCC_PATH/config
    echo 0x174908 3 > $DCC_PATH/config
    echo 0x176024 2 > $DCC_PATH/config
    echo 0x176158  > $DCC_PATH/config
    echo 0x176288  > $DCC_PATH/config
    echo 0x1822C8 6 > $DCC_PATH/config
    echo 0x1822F0  > $DCC_PATH/config
    echo 0x182424 2 > $DCC_PATH/config
    echo 0x183158  > $DCC_PATH/config
    echo 0x18329C  > $DCC_PATH/config
    echo 0x1833CC  > $DCC_PATH/config
    echo 0x183600  > $DCC_PATH/config
    echo 0x189174  > $DCC_PATH/config
    echo 0x189400  > $DCC_PATH/config
    echo 0x18A024 3 > $DCC_PATH/config
    echo 0x18A154  > $DCC_PATH/config
    echo 0x18A500  > $DCC_PATH/config
    echo 0x18A600  > $DCC_PATH/config
    echo 0x192000 16 > $DCC_PATH/config
    echo 0x192100  > $DCC_PATH/config
    echo 0x196000 16 > $DCC_PATH/config
    echo 0x197000 16 > $DCC_PATH/config
    echo 0x197100  > $DCC_PATH/config
    echo 0x1A2024  > $DCC_PATH/config
    echo 0x1A2400  > $DCC_PATH/config
    echo 0x1A4004 2 > $DCC_PATH/config
    echo 0x1A5600  > $DCC_PATH/config
    echo 0x1A7130  > $DCC_PATH/config
}
